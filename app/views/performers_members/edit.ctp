...
<?php echo $this->Form->create('PerformersMember');?>
	<fieldset>
		<legend><?php __('Edit Performers Member'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $this->Form->value('PerformersMember.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $this->Form->value('PerformersMember.id'))); ?></li>
