<div class="movies index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('performance_id');?></th>
	...
	<tr<?php echo $class;?>>
		...
		<td><?php echo $movie['Movie']['url']; ?>&nbsp;</td>
		...
		<td class="actions">
			...
			<?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $movie['Movie']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $movie['Movie']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
